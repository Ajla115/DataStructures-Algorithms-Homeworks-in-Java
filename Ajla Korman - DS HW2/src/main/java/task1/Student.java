...
public class Student implements Comparable<Student> {
    ...
    //Constructor - defines properties that have to be declared when the object is initialized
    public Student(int id, String fullName, String dateOfBirth, String universityName, String departmentCode, String departmentName, int yearOfEnrollment){
        this.id = id;
